...
![Compositing with 3D Meshes, fisheye lens and depth of field effect. Pure raytracing (47fps) vs hybrid rendering (110fps)](../images/raytrace_vs_hybrid_3dgut_fisheye_dof.png)
...
![Hybrid rendering pipeline, VK3DGUT/VK3DGRT for 3D Gaussians and 3D meshes](../images/pipeline_hybrid_rendering_3dgut_3dgrt_.png)

## Hybrid Rendering with 3DGS and 3DGRT

![Pure raytracing (54fps) vs hybrid rendering (199fps)](../images/hybrid_vs_raytrace.png) 
...
![Hybrid rendering pipeline, VK3DGS/VK3DGRT for 3D Gaussians and 3D meshes](../images/pipeline_hybrid_rendering_3dgs_3dgrt_.png)
